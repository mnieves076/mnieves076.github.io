	...
	loadMap: function(whichMap) {
		...
		switch(m) {
			...
			case 3: 
				...
				this.assetManager.addAsset("static-entity","static","image/House40-white.png","STATIC-ENTITY-1286168137544-6571",1400,420,80,80,house40Params);
				this.assetManager.addAsset("static-entity","static","image/House40-blue.png","STATIC-ENTITY-1286168141320-5305",1520,420,80,80,house40Params);
				...
				this.assetManager.addAsset("static-entity","static","image/House40-pink.png","STATIC-ENTITY-1286168150327-5787",1630,410,80,80,house40Params);
